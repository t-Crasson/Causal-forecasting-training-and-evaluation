...
class MIMIC3TFTDatasetCollectionCausal(RealDatasetCollection):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.train_f_s1 = dataset_class(treatments_train_s1, outcomes_train_s1, vitals_train_s1, static_features_train_s1,
                                         outcomes_unscaled_train_s1, scaling_params, 'train')
        self.train_f_s2 = dataset_class(treatments_train_s2, outcomes_train_s2, vitals_train_s2, static_features_train_s2,
        ...
        self.val_f_s1 = dataset_class(treatments_val_s1, outcomes_val_s1, vitals_val_s1, static_features_val_s1, outcomes_unscaled_val_s1,
                                        scaling_params, 'val')
        self.val_f_s2 = dataset_class(treatments_val_s2, outcomes_val_s2, vitals_val_s2, static_features_val_s2, outcomes_unscaled_val_s2,
                                        scaling_params, 'val')
